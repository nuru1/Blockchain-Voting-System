...
App = {
  ...
  render: function() {
    ...
    App.contracts.Election.deployed().then(function(instance) {
      ...
      //candidatesResults.append(result);
  ...
  resetElections: function(){
    console.log("Resetting Elections");
    App.contracts.Election.deployed().then(function(instance) {
      instance.resetElection();
      }).then(function(i){
        console.log('Rendering UI....');
        App.render();
      }).catch(function(err){
